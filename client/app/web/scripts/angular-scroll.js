    ...
    var createScrollHandler = function (context) {
        ...
        var handler = function () {
            ...
            if (toBeActive) {
                ...
                //enable_arrows(toBeActive.$element.data('slide'));
                ...
                if (toBeActive.$element.data('slide') != mytops.length) {

                    $('#arrow-down').removeClass('disabled');
                }
                if (toBeActive.$element.data('slide') == 3) {
                    $('#arrow-left').removeClass('disabled');
                    $('#arrow-right').removeClass('disabled');
                }


                var icon = toBeActive.$element.find('.icon');
                var icon = toBeActive.$element.find('.icon');
                var tx = toBeActive.$element.find('.text');
                var tx_pos = tx.offset().left - $('.nav').offset().left;
                var left_pos = icon.offset().left - $('.nav').offset().left;
                var el_width = icon.width() + toBeActive.$element.find('.text').width() - 10;
              ...
              'easeInOutQuart'
                ...
                $('.active-menu').promise().done(function () {
