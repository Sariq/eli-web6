(function () {
     ...
     * @constructor
     */
    function ProjectTaskController($location, $scope, PatientAdmin, $stateParams, ProjectService, $http, UserAdmin, $rootScope, $q, TaskgAdmin, AuthService) {
        var self = this;
        self.tagArr = [];
        self.sendToUser = [];
        self.userInfo = AuthService.getUserInfo();

        self.task = TaskgAdmin.create();
    ...
    angular.module('eli.admin')
        .controller('ProjectTaskController', ['$location', '$scope', 'PatientAdmin', '$stateParams', 'ProjectService', '$http', 'UserAdmin', '$rootScope', '$q', 'TaskgAdmin','AuthService', ProjectTaskController]);
}());
